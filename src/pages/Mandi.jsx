    ...
    <div className="relative pt-24 pb-16 px-6 md:px-16 font-cairo min-h-screen">
      <div className="max-w-5xl mx-auto bg-white/80 backdrop-blur-sm rounded-xl shadow-md p-8 space-y-8">
        ...
        <div className="rounded overflow-hidden border border-gray-300">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3625.000000000001!2d46.80000001500608!3d24.78000008411454!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjTCsDQ3JzQ4LjAiTiA0NsKwNDgnMDAuMCJF!5e0!3m2!1sen!2ssa!4v1718020000002!5m2!1sen!2ssa"
            width="100%"
            height="300"
            allowFullScreen=""
            loading="lazy"
